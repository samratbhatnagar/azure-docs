...
# Rehost: Migrate an on-premises app to Azure VMs 

This is the third article in a series that shows how the ficticious organization Contoso are moving their on-premises infrastructure to the Azure cloud. [Learn more](https://docs.microsoft.com/azure/migrate/migrate-scenarios-overview) about the series.
